              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginTop: 6 }}>
                ...
                {patient.coTruyenThuoc === "Có" && (
                  <Field label="Nhóm thuốc truyền">
                    <CheckGroup options={["Kháng sinh", "Giảm đau", "Vận mạch", "An thần", "Nimodipine", "Nicardipine", "Kali", "Hóa chất"]} values={patient.nhomThuoc} onChange={(v) => update("nhomThuoc", v)} otherKey="nhomThuocKhac" otherValue={patient.nhomThuocKhac} onOtherChange={(v) => update("nhomThuocKhac", v)} />
                  </Field>
                )}
